---
allowed-tools: Bash(git add:*), Bash(git commit:*), Bash(git push:*), Bash(npx vitest*), Bash(npm run test*)
---
...
4. Сообщи результат: количество тестов / что закоммичено / статус пуша
...
## Работа с задачами (TASKS.md и MEMORY.md)
- В начале каждой сессии читай TASKS.md и MEMORY.md
