...
function AppContent() {
  ...
  const Sidebar = (
    <div className={`${isMobile ? 'w-full' : 'w-80 flex-shrink-0 border-r border-white/5'} flex flex-col`}>
          ...
          {isAdmin && !isMobile && (
            <>
              <button onClick={() => { setAdminView('dashboard'); setActiveChat(null); if (isMobile) setMobileView('main'); }}
                className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 ${isAdminBtnActive('dashboard') ? 'bg-emerald-500 text-white' : 'text-[#8696a0] hover:text-[#e9edef]'}`}
                title="Dashboard">
              ...
              <button onClick={() => { setAdminView('tasks'); setActiveChat(null); if (isMobile) setMobileView('main'); }}
                className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 ${isAdminBtnActive('tasks') ? 'bg-emerald-500 text-white' : 'text-[#8696a0] hover:text-[#e9edef]'}`}
                title="Задачи">
              ...
              <button onClick={() => { setAdminView('reports'); setActiveChat(null); if (isMobile) setMobileView('main'); }}
                className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 ${isAdminBtnActive('reports') ? 'bg-emerald-500 text-white' : 'text-[#8696a0] hover:text-[#e9edef]'}`}
                title="Аналитика">
              ...
              <button onClick={() => { setAdminView('activity'); setActiveChat(null); if (isMobile) setMobileView('main'); }}
                className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 ${isAdminBtnActive('activity') ? 'bg-emerald-500 text-white' : 'text-[#8696a0] hover:text-[#e9edef]'}`}
                title="Активность">
              ...
              <button onClick={() => { setAdminView('cash'); setActiveChat(null); }}
                className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 ${isAdminBtnActive('cash') ? 'bg-emerald-500 text-white' : 'text-[#8696a0] hover:text-[#e9edef]'}`}
                title="Касса">
                <Banknote className="w-3.5 h-3.5" />
              </button>
              {employee.role === 'admin' && (
                <button onClick={() => { setAdminView('sales-history'); setActiveChat(null); }}
                  className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 ${isAdminBtnActive('sales-history') ? 'bg-emerald-500 text-white' : 'text-[#8696a0] hover:text-[#e9edef]'}`}
              ...
              <button onClick={() => setShowImport(true)}
                className="w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 text-[#8696a0] hover:text-[#e9edef]" title="Импорт Excel">
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
              </button>
              {employee.role === 'admin' && (
                <button
                  onClick={() => { setAdminView('settings'); setActiveChat(null); if (isMobile) setMobileView('main'); }}
                  className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 ${isAdminBtnActive('settings') ? 'bg-emerald-500 text-white' : 'text-[#8696a0] hover:text-[#e9edef]'}`}
                  title="Настройки">
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {employee.role === 'admin' && (
                <button
                  ...
                  className={`w-9 h-9 flex items-center justify-center rounded-lg transition-colors flex-shrink-0 relative ${isAdminBtnActive('watchlist') ? 'bg-emerald-500 text-white' : 'text-[#8696a0] hover:text-[#e9edef]'}`}
                  title="На заметке"
                >
      ...
      {isAdmin && isMobile && (
        <div
          className="grid bg-[#202c33] border-b border-white/10 px-1 py-1 flex-shrink-0"
          style={{ gridTemplateColumns: 'repeat(9, 1fr)', gridTemplateRows: 'repeat(2, auto)' }}
        >
          {/* ВЕРХНИЙ РЯД — чётные колонки */}
          <button
            onClick={() => { setAdminView('dashboard'); setActiveChat(null); setMobileView('main'); }}
            className={`flex flex-col items-center gap-0 py-0.5 ${isAdminBtnActive('dashboard') ? 'text-emerald-400' : 'text-[#8696a0]'}`}
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0 py-0.5 ${isAdminBtnActive('tasks') ? 'text-emerald-400' : 'text-[#8696a0]'}`}
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0 py-0.5 ${isAdminBtnActive('reports') ? 'text-emerald-400' : 'text-[#8696a0]'}`}
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0 py-0.5 ${isAdminBtnActive('activity') ? 'text-emerald-400' : 'text-[#8696a0]'}`}
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0 py-0.5 ${isAdminBtnActive('expenses') ? 'text-emerald-400' : 'text-[#8696a0]'}`}
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0 py-0.5 ${isAdminBtnActive('cash') ? 'text-emerald-400' : 'text-[#8696a0]'}`}
          ...
          {employee.role === 'admin' && (
            <button
              ...
              className={`flex flex-col items-center gap-0 py-0.5 ${isAdminBtnActive('settings') ? 'text-emerald-400' : 'text-[#8696a0]'}`}
          ...
          {employee.role === 'admin' && (
            <button
              ...
              className={`relative flex flex-col items-center gap-0 py-0.5 ${isAdminBtnActive('watchlist') ? 'text-emerald-400' : 'text-[#8696a0]'}`}
  ...
  const MainArea = (
    <div className="flex-1 flex overflow-hidden">
      ...
      ) : isAdmin && adminView === 'sales-history' ? (
        <div className="flex-1 flex flex-col overflow-hidden">
