            ...
            <div className="flex gap-2 items-center w-full">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4H7a3 3 0 00-3 3v5M4 16v1a3 3 0 003 3h1M20 12v-1a3 3 0 00-3-3h-1M16 20h1a3 3 0 003-3v-1M8 8h2v2H8zM8 14h2v2H8zM14 8h2v2h-2z" />
                </svg>
              </button>
            </div>
