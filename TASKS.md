...
**Проверено пользователем:** T54 и разбивка Halyk/Kaspi-перевод подтверждены на тесте. Бейдж admin и история заявок — не проверены на тесте отдельно, но код зеркалит уже рабочий менеджерский паттерн.
